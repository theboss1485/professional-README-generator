...
After I created and submitted the walkthrough video, I realized that I had mixed camel case file names (generateMarkdown) and dashed file names (generate-markdown).  Therefore, I went back and renamed the files to use dashes.  As such some of my files have slightly different names than they did in the walkthrough video.  If this is a problem, let me know and I can redo the video.
